...
if __name__ == "__main__":
    ...
    delete(server + cse + "Team-13", data_format="json")
    create_ae(server + cse, "Team-13","team13")
    create_cnt(server + cse + "Team-13/","Node-1", "team13")
    create_cnt(server + cse + "Team-13/Node-1/", "Data", "team13")
    create_data_cin(server + cse + "Team-13/Node-1/Data/", "[x y time]","team13")